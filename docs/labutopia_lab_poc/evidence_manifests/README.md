...
mdl_water_visual_pass_official=true
mdl_water_visual_a_manifest=fluid_spike_visual_a_official_20260709.json
mdl_water_visual_a_rubric_manifest=fluid_spike_visual_a_official_rubric_20260709.json
mdl_water_visual_a_backend=MDL_WATER
mdl_water_visual_a_compile_status=PASS
mdl_water_visual_a_sub_identifier=OmniSurface_ClearWater
