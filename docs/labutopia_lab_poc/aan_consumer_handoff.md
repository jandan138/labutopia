...
继续点要从“手工修 LabUtopia USD 资产”切换为“标准化 consumer runtime bootstrap、
保持 no-local-repair guard、推进 semantic evaluator 和 material parity follow-up”。
...
这次 final run 依赖两个 consumer runtime bootstrap 条件，后续应固化进 runner：
