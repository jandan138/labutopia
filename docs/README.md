...
- [labutopia_lab_poc/true_physx_pbd_fluid_spike.md](labutopia_lab_poc/true_physx_pbd_fluid_spike.md): True PhysX/PBD Fluid 的最小可行性、S0-S7 stop-go、S2/S3 collider matrix 和 claim boundary；独立于 AAN rigid/articulation consumer smoke 与 EOS2 Expert Oracle Score 主线。
