...
experiment_id="real_beaker_ao_rt_matrix_v3_20260712_005"
...
implementation_identity="$repo_root/docs/labutopia_lab_poc/evidence_manifests/real_beaker_ao_rt_matrix_v3_20260712_005_implementation_identity.json"
pre_freeze="$repo_root/docs/labutopia_lab_poc/evidence_manifests/real_beaker_ao_rt_matrix_v3_20260712_005_protected_tree_freeze_pre.json"
...
for sequence in "${!variants[@]}"; do
    ...
    log_path="/tmp/labutopia-formal-005-${cell_name}.log"
    if $print_plan; then
